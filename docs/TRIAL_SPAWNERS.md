...
- **Mining speed is adjustable.** A trial spawner takes about ten times as long to mine as a regular spawner. `breakSpeedMultiplier` speeds the dig up for players who would actually receive the drop - everyone else keeps the vanilla pace.

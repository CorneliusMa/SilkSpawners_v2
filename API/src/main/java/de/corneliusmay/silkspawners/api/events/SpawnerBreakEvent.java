...
public class SpawnerBreakEvent extends SpawnerEvent {
    ...
    @ApiStatus.Internal
    public SpawnerBreakEvent(Player player, SpawnerSnapshot spawner, Location location, Function<EntityType, SpawnerSnapshot> snapshotFactory) {
        super(player, spawner, location, snapshotFactory);
    }

    /**
     * Replaces the dropped spawner.
     *

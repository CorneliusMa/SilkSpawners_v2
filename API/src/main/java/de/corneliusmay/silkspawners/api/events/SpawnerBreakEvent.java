...
/**
 * Called when a player breaks a spawner and the spawner will drop.
 * Cancelling cancels the block break and nothing drops. The spawner stays placed.
 */
public class SpawnerBreakEvent extends SpawnerEvent {
    ...
    /**
     * Replaces the dropped spawner. The replacement keeps the current spawner's block settings.
     *
    ...
    /**
     * Replaces the dropped spawner with the given entity type and block settings.
     *
     * @param entityType the new entity type, {@code null} for an empty spawner
